    ...
    if (ptr) {
        ...
        if (it != std::string::npos) {
            ...
            try {
                ...
                BOOST_LOG_S5B_ID(relayId, trace) << "host:" << host;
                BOOST_LOG_S5B_ID(relayId, trace) << "port:" << port;
            ...
            // not find
            BOOST_LOG_S5B_ID(relayId, warning) << "do_analysis_client_first_http_header not find";
